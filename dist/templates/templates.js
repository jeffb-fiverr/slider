this["slider"] = {"1":function(depth0,helpers,partials,data) {
  ...
  return "            <span class=\"slide-current\"></span> "
  ...
  buffer += ">\n                <div class=\"thumbnail\">\n"
    + ((stack1 = helpers.unless.call(depth0,(depths[1] != null ? depths[1].mobile : depths[1]),{"name":"unless","hash":{},"fn":this.program(10, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.thumbnail : depth0),{"name":"if","hash":{},"fn":this.program(17, data, 0, blockParams, depths),"inverse":this.program(19, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "")
    + "                </div>\n\n";
  stack1 = ((helper = (helper = helpers.review || (depth0 != null ? depth0.review : depth0)) != null ? helper : alias1),(options={"name":"review","hash":{},"fn":this.program(21, data, 0, blockParams, depths),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  ...
  return ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.typeVideo : depth0),{"name":"if","hash":{},"fn":this.program(11, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.typeAudio : depth0),{"name":"if","hash":{},"fn":this.program(13, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.typePdf : depth0),{"name":"if","hash":{},"fn":this.program(15, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "");
  ...
  return "                        <img src=\""
    ...
    return "                        <div class=\"audio-wave\"></div>\n";
  ...
  stack1 = ((helper = (helper = helpers.slides || (depth0 != null ? depth0.slides : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"slides","hash":{},"fn":this.program(24, data, 0),"inverse":this.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0,options) : helper));
  ...
  return "                    <div class=\"thumb js-thumb\">\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.thumbnail : depth0),{"name":"if","hash":{},"fn":this.program(25, data, 0),"inverse":this.program(27, data, 0),"data":data})) != null ? stack1 : "")
    + "                    </div>\n";
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + "    </div>\n\n"
    + ((stack1 = helpers.unless.call(depth0,(depth0 != null ? depth0.mobile : depth0),{"name":"unless","hash":{},"fn":this.program(23, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
