this["slider"] = {"1":function(depth0,helpers,partials,data) {
  ...
  buffer += ">\n                <div class=\"thumbnail\">\n"
    ...
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.typePdf : depth0),{"name":"if","hash":{},"fn":this.program(14, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\n"
    ...
    + "                </div>\n\n";
  stack1 = ((helper = (helper = helpers.review || (depth0 != null ? depth0.review : depth0)) != null ? helper : alias1),(options={"name":"review","hash":{},"fn":this.program(20, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  ...
  stack1 = ((helper = (helper = helpers.slides || (depth0 != null ? depth0.slides : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"slides","hash":{},"fn":this.program(23, data, 0),"inverse":this.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0,options) : helper));
  ...
  return "                    <div class=\"thumb js-thumb\">\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.thumbnail : depth0),{"name":"if","hash":{},"fn":this.program(24, data, 0),"inverse":this.program(26, data, 0),"data":data})) != null ? stack1 : "")
    + "                    </div>\n";
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + "    </div>\n\n"
    + ((stack1 = helpers.unless.call(depth0,(depth0 != null ? depth0.mobile : depth0),{"name":"unless","hash":{},"fn":this.program(22, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
